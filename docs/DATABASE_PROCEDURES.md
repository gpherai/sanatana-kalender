...
- Seeding van DailyInfo (panchanga data 2025–2027)
...
**Opties:**
- `--start` / `--end` — datum window (standaard 2025-01-01 / 2027-12-31)
...
Gezonde staat: alle 127 events hebben `autoGenerated=true` en een `namingKey`, ~560 occurrences.
