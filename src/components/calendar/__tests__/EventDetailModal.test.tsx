...
describe("EventDetailModal", () => {
  ...
  it("renders nothing when closed", () => {
    render(<EventDetailModal event={MOCK_EVENT} isOpen={false} onClose={vi.fn()} />);
  ...
  it("closes confirm dialog on escape without closing modal", () => {
    ...
    render(<EventDetailModal event={MOCK_EVENT} isOpen={true} onClose={onClose} />);
  ...
  it("closes when clicking the backdrop", () => {
    ...
    const { container } = render(
      <EventDetailModal event={MOCK_EVENT} isOpen={true} onClose={onClose} />
    );
  ...
  it("shows multi-day label when original end date is set", () => {
    ...
    render(<EventDetailModal event={multiDayEvent} isOpen={true} onClose={vi.fn()} />);
  ...
  it("does not render notes section when notes are missing", () => {
    ...
    render(<EventDetailModal event={noNotesEvent} isOpen={true} onClose={vi.fn()} />);
