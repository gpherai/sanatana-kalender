        ...
        {days.map((date) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group focus-visible:ring-theme-primary relative flex min-h-[44px] flex-col rounded-lg p-1.5 text-left transition-colors focus-visible:ring-2 focus-visible:ring-offset-1 focus-visible:outline-none active:opacity-75",
                isSelected
