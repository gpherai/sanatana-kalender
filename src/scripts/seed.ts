      ...
      try {
        ...
        await prisma.dailyInfo.upsert({
          ...
          create: {
            ...
            sunrise: strToDbTime(panchanga.sunriseLocal),
            sunset: strToDbTime(panchanga.sunsetLocal),
            moonrise: strToDbTime(panchanga.moonriseLocal ?? null),
            moonset: strToDbTime(panchanga.moonsetLocal ?? null),
            moonPhasePercent: Math.round(panchanga.moon.illuminationPct),
            moonPhaseType: moonPhaseType,
            isWaxing: panchanga.moon.waxing,
            tithi: tithiEnum,
            tithiEndTime: strToDbTime(panchanga.tithi.endLocal ?? null),
            nakshatra: nakshatraEnum,
            nakshatraEndTime: strToDbTime(panchanga.nakshatra.endLocal ?? null),
            yogaName: panchanga.yoga.name,
            yogaEndTime: strToDbTime(panchanga.yoga.endLocal ?? null),
            karanaName: panchanga.karana.name,
            karanaType: panchanga.karana.type,
            karanaEndTime: strToDbTime(panchanga.karana.endLocal ?? null),
            paksha: pakshaEnum,
            maas: maasEnum,
            ...
            sankranti: panchanga.sankranti?.name
              ...
              : null,
            sankrantiTime: strToDbTime(panchanga.sankranti?.time ?? null),
            ...
            sunSignUpto: strToDbTime(panchanga.sunSign?.uptoLocal ?? null),
            moonSignNumber: panchanga.moonSign?.number ?? null,
            moonSignUpto: strToDbTime(panchanga.moonSign?.uptoLocal ?? null),
            ...
            nextTithiEndTime: strToDbTime(panchanga.nextTithi?.endLocal ?? null),
            ...
            nextNakshatraEndTime: strToDbTime(panchanga.nextNakshatra?.endLocal ?? null),
            nextYogaNumber: panchanga.nextYoga?.number ?? null,
            nextYogaName: panchanga.nextYoga?.name ?? null,
            nextYogaEndTime: strToDbTime(panchanga.nextYoga?.endLocal ?? null),
            ...
            nextKaranaEndTime: strToDbTime(panchanga.nextKarana?.endLocal ?? null),
          },
          update: {
            locationName: panchanga.location.name,
            locationLat: panchanga.location.lat,
