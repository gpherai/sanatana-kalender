...
async function validateAgainstDrik2025() {
  ...
  console.log(`\n📊 Parsed ${drikEvents.length} events from Drik Panchang 2025\n`);
  ...
  console.log(`📊 We have ${ourEvents.length} events in database\n`);
  ...
  console.log(`✅ Found in our database: ${found.length}`);
