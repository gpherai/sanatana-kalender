  ...
  describe("getSpecialLunarDays", () => {
      ...
      const monthData = [
        {
          ...
          tithi: { number: 2, paksha: "Krishna", name: "Dwitiya" } as TithiInfo,
        }, // Normal
        {
          date: new Date("2024-01-11"),
          tithi: { number: 11, paksha: "Krishna", name: "Ekadashi" } as TithiInfo,
        }, // Special
        {
          date: new Date("2024-01-15"),
          tithi: { number: 15, paksha: "Krishna", name: "Amavasya" } as TithiInfo,
        }, // Special
      ];
    ...
    it("should handle string dates correctly", () => {
      const monthData = [
        {
          date: "2024-01-11",
          tithi: { number: 11, paksha: "Shukla", name: "Ekadashi" } as TithiInfo,
        },
      ];
