...
export const CATEGORY_CATALOG: readonly CategoryDefinition[] = [
  ...
  },
  {
    ...
    displayName: "Ma Tara",
    icon: "⭐",
    color: "oklch(0.40 0.20 232)",
    colorDark: "oklch(0.70 0.18 232)",
    sortOrder: 17,
    description:
