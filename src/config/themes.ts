...
export const THEME_CATALOG: readonly ThemeDefinition[] = [
  ...
  {
    name: "krishna-mayura",
    displayName: "🦚 Krishna Mayura",
    description: "Peacock blue and pitambara gold of the flute-player of Vrindavan",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.22 255)",
      secondary: "oklch(0.75 0.14 90)",
      accent: "oklch(0.55 0.15 190)",
    },
  },
  {
    name: "shri-lakshmi",
    displayName: "🪷 Shri Lakshmi",
    description: "Lotus rose and abundant gold of the goddess of fortune",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.22 355)",
      secondary: "oklch(0.75 0.14 88)",
      accent: "oklch(0.55 0.15 150)",
    },
  },
  {
    name: "saraswati-shubhra",
    displayName: "🦢 Saraswati Shubhra",
    description: "Pristine white, saffron and water-blue of the goddess of wisdom",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.136 82)",
      secondary: "oklch(0.75 0.087 85)",
      accent: "oklch(0.55 0.093 245)",
    },
  },
  {
    name: "jyotsna-purnima",
    displayName: "🌕 Jyotsna",
    description: "Silver moonlight of the full-moon night",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.11 245)",
      secondary: "oklch(0.75 0.07 90)",
      accent: "oklch(0.55 0.075 285)",
    },
  },
  {
    name: "ganga-pravaha",
    displayName: "🌊 Ganga Pravaha",
    description: "Glacial turquoise and ghat-lamp gold of the sacred river",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.202 200)",
      secondary: "oklch(0.75 0.129 80)",
      accent: "oklch(0.55 0.138 205)",
    },
  },
  {
    name: "vasanta-ritu",
    displayName: "🌸 Vasanta Ritu",
    description: "Fresh chartreuse, marigold and blossom of the spring season",
    isDefault: false,
    category: "special" as const,
    isSpecial: true,
    colors: {
      primary: "oklch(0.55 0.231 128)",
      secondary: "oklch(0.75 0.147 92)",
