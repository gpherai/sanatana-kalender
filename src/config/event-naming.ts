...
export const EVENT_NAMING_CATALOG: EventNaming[] = [
  ...
  {
    key: "soma_pradosh_krishna",
    name: "Soma Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 1 },
    description:
      "Soma Pradosh Vrat valt op de Krishna Trayodashi die op een maandag (Somavar) ligt. Maandag is de dag van Soma (de Maan) en van Heer Shiva — Somavar Pradosh staat daarmee dubbel in het teken van Shiva. Het vasten schenkt emotionele harmonie, familiezegen en de bescherming van Godin Parvati. Devotees vasten tot na zonsondergang, wassen de Shiva Lingam met melk en pancha-amrit en chanten Om Namah Shivaya.",
    tags: [
      "krishna paksha",
      "maandag",
      "parvati",
  ...
  },
  {
    ...
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "SHUKLA", weekday: 2 },
    description:
      "Bhauma Pradosh Vrat valt op de Shukla Trayodashi die op een dinsdag (Mangalavar) ligt. Dinsdag is de dag van Bhauma (Mars, Mangal). Dit Pradosh versterkt moed, doorzettingsvermogen en bescherming tegen vijanden. Het is bijzonder gunstig voor het overwinnen van obstakels en voor de gezondheid van het bloed en de vitaliteit. Devotees offeren rode bloemen en recieren de Maha Mrityunjaya Mantra.",
    tags: [
      "bhauma",
      "bescherming",
      "dinsdag",
  ...
  },
  {
    ...
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "SHUKLA", weekday: 3 },
    description:
      "Budha Pradosh Vrat valt op de Shukla Trayodashi die op een woensdag (Budhavar) ligt. Woensdag is de dag van Budha (Mercurius), de planeet van intellect en communicatie. Dit Pradosh schenkt helderheid van geest, verbeterde concentratie en succes in onderwijs en handel. Devotees vasten en offeren groene bloemen of bilva-bladeren.",
    tags: [
      "budha",
      "intellect",
      "mercurius",
  ...
  {
    key: "budha_pradosh_krishna",
    name: "Budha Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 3 },
    description:
      "Budha Pradosh Vrat valt op de Krishna Trayodashi die op een woensdag (Budhavar) ligt. Woensdag is de dag van Budha (Mercurius), de planeet van intellect en communicatie. Dit Pradosh schenkt helderheid van geest, verbeterde concentratie en succes in onderwijs en handel. Devotees vasten en offeren groene bloemen of bilva-bladeren.",
    tags: [
      "budha",
      "intellect",
      "krishna paksha",
  ...
  },
  {
    ...
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "SHUKLA", weekday: 4 },
    description:
      "Guru Pradosh Vrat valt op de Shukla Trayodashi die op een donderdag (Guruvaar) ligt. Donderdag is de dag van Guru Brihaspati (Jupiter), de leraar van de goden. Dit Pradosh verdiept spirituele kennis, versterkt geloof en brengt de zegen van leermeester en voorspoed. Devotees vasten en reciteren de Shiva Sahasranama.",
    tags: [
      "brihaspati",
      "donderdag",
      "guru",
  ...
  {
    key: "guru_pradosh_krishna",
    name: "Guru Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 4 },
    description:
      "Guru Pradosh Vrat valt op de Krishna Trayodashi die op een donderdag (Guruvaar) ligt. Donderdag is de dag van Guru Brihaspati (Jupiter), de leraar van de goden. Dit Pradosh verdiept spirituele kennis, versterkt geloof en brengt de zegen van leermeester en voorspoed. Devotees vasten en reciteren de Shiva Sahasranama.",
    tags: [
      "brihaspati",
      "donderdag",
      "guru",
  ...
  },
  {
    ...
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "SHUKLA", weekday: 5 },
    description:
      "Shukra Pradosh Vrat valt op de Shukla Trayodashi die op een vrijdag (Shukravar) ligt. Vrijdag is de dag van Shukra (Venus), de planeet van liefde, schoonheid en welvaart. Dit Pradosh schenkt huwelijksgeluk, harmonie in relaties en materiële overvloed. Devotees offeren witte bloemen en melk aan Shiva en Parvati gezamenlijk.",
    tags: [
      "liefde",
      "parvati",
      "pradosh",
  ...
  {
    key: "shukra_pradosh_krishna",
    name: "Shukra Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 5 },
    description:
      "Shukra Pradosh Vrat valt op de Krishna Trayodashi die op een vrijdag (Shukravar) ligt. Vrijdag is de dag van Shukra (Venus), de planeet van liefde, schoonheid en welvaart. Dit Pradosh schenkt huwelijksgeluk, harmonie in relaties en materiële overvloed. Devotees offeren witte bloemen en melk aan Shiva en Parvati gezamenlijk.",
    tags: [
      "krishna paksha",
      "liefde",
      "parvati",
  ...
  {
    key: "shani_pradosh_krishna",
    name: "Shani Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 6 },
    description:
      "Shani Pradosh Vrat valt op de Krishna Trayodashi die op een zaterdag (Shanivaar) ligt. Zaterdag is de dag van Shani (Saturnus), de planeet van karma en rechtvaardigheid. Shani Pradosh is bijzonder krachtig: het samenspel van Shiva's vergeving en Shani's karmische wet maakt dit vasten uiterst geschikt voor het zuiveren van oude karma, het verlichten van Sade Sati-effecten en het streven naar bevrijding (moksha). Devotees vasten strikt en offeren sesam (til) en sesamolie aan Shiva.",
    tags: [
      "karma",
      "krishna paksha",
      "moksha",
  ...
  {
    key: "ravi_pradosh_krishna",
    name: "Ravi Pradosh Vrat",
    categories: ["shiva"],
    eventType: "VRAT",
    ruleType: "PRADOSH",
    ruleConfig: { paksha: "KRISHNA", weekday: 0 },
    description:
      "Ravi Pradosh Vrat valt op de Krishna Trayodashi die op een zondag (Ravivaar) ligt. Zondag is de dag van Ravi (de Zon), de bron van leven en kracht. Dit Pradosh schenkt gezondheid, levensenergie, zelfvertrouwen en succes in leiderschap. Devotees vasten en verrichten de Surya-Shiva puja — Shiva als de kosmische zon (Maheshvara) wordt aanbeden met rode bloemen en sindhoor.",
    tags: [
      "gezondheid",
      "krishna paksha",
      "pradosh",
